...
//        HairStyle(name: "댄디컷", type: .cut, price: 48000),
        HairStyle(name: "애즈펌", type: .perm, price: 45000),
        HairStyle(name: "리프펌", type: .perm, price: 46000),
        HairStyle(name: "포마드펌", type: .perm, price: 50000),
        HairStyle(name: "가르마펌", type: .perm, price: 55000),
        HairStyle(name: "쉐도우펌", type: .perm, price: 52000),
...
//        HairStyle(name: "바디펌", type: .perm, price: 53000),
        HairStyle(name: "뿌리염색", type: .color, price: 80000),
        HairStyle(name: "전체염색", type: .color, price: 110000),
        HairStyle(name: "부분염색", type: .color, price: 90000),
    ]
}
